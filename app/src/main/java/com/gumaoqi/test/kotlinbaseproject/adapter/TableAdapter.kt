...
import com.gumaoqi.test.kotlinbaseproject.base.HandlerArg.Companion.GO_TO_DELETE_TABLE
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        when (viewHolder) {
            is ContentViewHolder -> {
                ...
                viewHolder.itemItemThreeTv.text = "创建时间：${result.createdAt}"
                ...
                viewHolder.itemItemLl.setOnClickListener {
                    ...
                    message.arg1 = GO_TO_DELETE_TABLE
                    message.obj = result
